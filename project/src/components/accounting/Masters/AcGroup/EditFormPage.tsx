    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 p-4">
      <div className="fixed top-[10%] bg-white p-8 rounded-xl shadow-lg w-full max-w-4xl border border-blue-500 relative">
        ...
        <div className="space-y-4">
          ...
          {[
            { label: "Ledger Code", name: "ledgerCode" },
            { label: "Ledger Name", name: "ledgerName" },
            { label: "Short Name", name: "shortName" },
            { label: "Ledger Type", name: "ledgerType" },
            { label: "Short Code", name: "shortCode" },
            { label: "GL Reference", name: "glReference" },
          ].map(({ label, name }) => (
            <div key={name}>
