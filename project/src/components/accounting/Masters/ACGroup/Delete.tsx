  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row gap-4">
        <motion.div whileHover={{ scale: 1.02 }} className="flex-1 relative bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <motion.div whileHover={{ scale: 1.02 }} className="relative bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <motion.tr key={index} whileHover={{ scale: 1.02 }} className="group hover:bg-blue-50 transition-all duration-150 text-lg">
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-8 text-center text-lg text-gray-500">No matching records found</td>
                  </tr>
                )}
              </tbody>
            </table>
